...
BEGIN
  ...
  -- Free trial expiry: 14 days from signup (kept).
  ...
  -- Preview receipt cap (default 200). The free tier no longer has a
  -- transaction cap during its 14-day trial; only the expiry above applies.
