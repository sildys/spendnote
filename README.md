...
- [ ] **S2** Stripe prep (ready to plug in): subscription state data model + feature flags + UI placeholders + webhook handling plan — S1-SPEC.md done, code/UI not yet implemented
