...
## Where we are now (last updated: 2026-05-22 14:50 — G.10 FINOMÍTÁS Codex direktívával: G.10.A Above-the-fold rule + G.10.B Top-third pattern + G.10.C anti-rule + G.10.D PROTECTED-state kettéosztva SEO/Ads + G.10.E AF/FV audit-oszlopok + audit-fájl 7.6 P0-per-oldal-besorolás + drip-feed-DRAFT-sorrend Codex-finomítással):
