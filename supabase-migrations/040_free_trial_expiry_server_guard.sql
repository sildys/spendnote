-- 040: Add server-side free trial expiry check (14 days from signup) to create transaction RPC
-- Client-side check exists but can be bypassed. This enforces it at DB level.
...
BEGIN
  ...
  -- Free trial expiry: 14 days from signup
  ...
  -- Count active (non-system, non-voided) transactions
